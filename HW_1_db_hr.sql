...
-- 4. Выведите информацию о работниках с их позициями
-- в формате: Donald(SH_CLERK). Назовите столбец our_employees.
...
-- - максимальную з/п назовите столбец max,
...
-- 7. Выведите на экран предложение «Peter's dog is very clever»,
-- используя одну из двух техник работы с одинарными кавычками.

SELECT q'<Peter's dog is very clever>'
FROM dual;


-- 8. Выведите на экран предложение «Peter's dog is very clever»,
-- используя, отличную от предыдущего примера, технику работы с одинарными кавычками.
